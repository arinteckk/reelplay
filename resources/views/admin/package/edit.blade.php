    ...
    <div class="body-content">
      ...
      <div class="card custom-border-card mt-3">
          ...
          <div class="form-row">
            ...
            <div class="col-md-6 mb-3">
              <div class="form-group">
                <label for="watch_on_laptop_tv">{{__('Label.Watch On Laptop Or TV')}}</label>
          ...
          <div class="form-row">
            <div class="col-md-6 mb-3">
              <div class="form-group">
                <label for="ads_free_movies_shows">{{__('Label.Ads Free Movies and Shows')}}</label>
            ...
            <div class="col-md-6 mb-3">
              <div class="form-group">
                <label for="no_of_device">{{__('Label.Number of Devices that can be Logged In')}}</label>
          ...
          <div class="form-row">
            <div class="col-md-3 mb-3 mt-3">
              <div class="form-group">
                <label for="type">Package Time</label>
            ...
            <div class="col-md-6 mb-3 mt-3">
              <div class="form-group">
                <label for="video_qulity">{{__('Label.Video Quality')}}</label>
          ...
          <div class="form-row">
            <div class="col-md-6 mb-3">
              <div class="form-group">
                <label for="name">Android Product Package</label>
            ...
            <div class="col-md-6 mb-3">
              <div class="form-group">
                <label for="price">IOS Product Package</label>
