...
class HomeController extends Controller
{
    ...
    public function add_transaction(Request $request)
    {
        try {
            ...
            $unique_id = isset($request->unique_id) ? $request->unique_id : 0;
            ...
            if (isset($coupon_check)) {
                ...
                if ($request->apply_coupon_type == 1) {
                    ...
                    if ($coupon_check['amount_type'] == 1) {
                        ...
                        $discount_amount = ($coupon_check['price'] / 100) * $Pdata['price'];
                    ...
                    if ($coupon_check['amount_type'] == 1) {
                        ...
                        $discount_amount = ($coupon_check['price'] / 100) * $Rent_Video['price'];
